  ...
  return (
    <section id="about" className="py-24">
      <div className="section-shell">
        <div {...intro} className="mx-auto max-w-3xl text-center">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {highlights.map((h, i) => {
            const reveal = useReveal<HTMLDivElement>(i * 120);
            return (
              <div
                key={h.title}
                {...reveal}
                className={`${reveal.className} rounded-2xl border border-border bg-card p-8 text-center shadow-soft`}
              >
